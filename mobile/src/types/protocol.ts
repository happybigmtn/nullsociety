 ...
 * Ensures type-safe message parsing at runtime
 */
import { z } from 'zod';
...
export const UltimateTXMessageSchema = BaseMessageSchema.extend({
  ...
  playerHand: PokerHandSchema.optional(),
  dealerHand: PokerHandSchema.optional(),
  dealerQualifies: z.boolean().optional(),
  anteResult: z.enum(['win', 'loss', 'push']).optional(),
  blindResult: z.enum(['win', 'loss', 'push']).optional(),
  playResult: z.enum(['win', 'loss', 'push']).optional(),
  tripsResult: z.enum(['win', 'loss']).optional(),
  payout: z.number().optional(),
  message: z.string().optional(),
